...
const ImageList = [
  {
    ...
    title: "Rudraksha",
    description:
      "Among All the beads of seeds, Rudraksha is considered the most pious and divine.",
  },
  {
    id: 2,
    img: hero_r2,
    title: "100% AUTHENTIC NEPAL ORIGINAL RUDRAKSHA",
    description:
      "Among All the beads of seeds, Rudraksha is considered the most pious and divine.",
  },
  {
    id: 3,
    img: hero_r3,
    title: "Several Mukhi Of Rudraksha",
    description:
      "Among All the beads of seeds, Rudraksha is considered the most pious and divine.",
  },
];
                ...
                <div className="order-1 sm:order-2">
                  ...
                  >
                    <img
                      src={data.img}
                      alt=""
                      className="w-[300px] h-[300px] mix-blend-multiply sm:h-[450px] sm:w-[450px] sm:scale-105 lg:scale-120 object-contain mx-auto "
                    />
                  </div>
                </div>
              </div>
